...
export const Lobby: React.FC<LobbyProps> = ({ onCreateGame, onJoinGame }) => {
  ...
  return (
    <div className="flex flex-row h-[100dvh] lg:min-h-screen lg:items-center lg:justify-between bg-bitwin-bg overflow-hidden lg:overflow-visible text-center">
      ...
      {/* --- CENTER CONTENT --- */}
      <div className="flex-1 flex flex-col items-center justify-center h-full w-full relative z-10 p-4 overflow-y-auto">
        
        {/* Logo Area */}
        <div className="mb-8 transform rotate-[-2deg] flex-none">
        ...
        <div className="w-full max-w-md bg-bitwin-card border-4 border-white/10 p-8 rounded-[2rem] shadow-2xl relative flex-none">
